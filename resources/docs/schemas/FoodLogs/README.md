...
**Lợi ích:** Đảm Olly tính toàn vẹn (Immutable) của dữ liệu lịch sử. Lỡ 2 năm sau `FoodData` cập nhật lại Calo của quả Táo, thì lịch sử 2 năm trước của user vẫn giữ nguyên con số Calo lúc bấy giờ.
